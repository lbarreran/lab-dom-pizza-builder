...
function renderWhiteSauce() {
  ...
  sauceSection.classList.toggle('sauce-white', state.whiteSauce);
}

function renderGlutenFreeCrust() {
  // Iteration 2: add/remove the class "crust-gluten-free" of `<section class="crust">`
  const crustSection = document.querySelector('.crust');
  crustSection.classList.toggle('crust-gluten-free', state.glutenFreeCrust);
}
...
function renderPrice() {
  // Iteration 4: change the HTML of `<aside class="panel price">`
    ...
    const priceTotal = document.querySelector('.panel.price strong');
